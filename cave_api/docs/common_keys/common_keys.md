...
<a name="color-by-null">colorByOptions.nullColor</a> | `'rgb(0,0,0)'` | The color to set any objects with a null value for the given prop. Can also by set to the `None` keyword to hide these objects. Not supported for groupable nodes.
...
<a name="size-by-null">sizeByOptions.nullSize</a> | `None` | The size to set any objects with a null value for the given prop. Can also by set to the `None` keyword to hide these objects. Not supported for groupable nodes.
