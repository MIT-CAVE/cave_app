# Generated by Django 4.1.1 on 2022-10-27 20:57
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="Should the site rquire users to have an accepted status to use the site? - Used in views to enable/disable check for accepted status",
                        verbose_name="Use Status Acceptance",
                    ),
                ),
                (
                    ...
                    models.IntegerField(
                        default=2,
                        help_text="Integer. The amount of personal sessions a user can have - Used in views to enable/disable session limit",
                        verbose_name="Limit for Personal Sessions",
                    ),
                ),
                (
                    "limit_team_sessions",
                    models.IntegerField(
                        default=2,
                        help_text="Integer. The amount of sessions a team can have - Used in views to enable/disable session limit for teams",
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="Require users to validate their emails before accessing the app? - Used in app login to enable/disable email validation",
                        verbose_name="Require Email Validation",
                    ),
                ),
                (
                    "primary_color",
